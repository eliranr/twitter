...
export default function Sidebar() {
  ...
  return (
    <div className='hidden sm:flex flex-col p-2 xl:items-start fixed h-full xl:ml-24'>
        ...
        <div className='my-4 mb-2.5 xl:items-start'>
            <SidebarMenuItem text="Home" Icon={HomeIcon} active={true} />
            <SidebarMenuItem text="Explore" Icon={HashtagIcon} />
            {session && (
                <>
                <SidebarMenuItem text="Notofication" Icon={BellIcon} />
        ...
        {session ? (
            ...
            <button onClick={signIn} className='bg-red-400 rounded-full w-56 h-12 font-bold shadow-md hover:brightness-95 text-lg hidden xl:inline'>Sign In</button>
        )
    }
